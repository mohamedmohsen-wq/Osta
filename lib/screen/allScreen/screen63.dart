          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(width: 1.0, color: change==1? Color(0xff1EC1AD):Color(0xffebebeb)),
                boxShadow: [
                  BoxShadow(
                      ...
                      Row(
                        ...
                        children: [
                          Column(
                            children: [
                              Container(
                                margin: EdgeInsetsDirectional.only(end: 63),
                                child: Text(
                                  'المنزل',
                                  style: TextStyle(
                                    fontSize: 13,
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xffffffff),
                borderRadius: BorderRadius.circular(8.0),
                border: Border.all(width: 1.0, color: change==2? Color(0xff1EC1AD):Color(0xffebebeb)),
                boxShadow: [
                  BoxShadow(
                    color: const Color(0x0d000000),
                    offset: Offset(0, 3),
